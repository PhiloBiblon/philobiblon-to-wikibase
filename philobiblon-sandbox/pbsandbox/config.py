...
mediawiki_api_endpoint = 'https://pbsandbox.wikibase.cloud/w/api.php'

# SPARQL endpoint
wikibase_sparql_endpoint = 'https://pbsandbox.wikibase.cloud/query/sparql'

# Name of the Wikibase instance
wikibase_name = 'PB sandbox'

# URL of the main page of the Wikibase instance
wikibase_main_page = 'https://pbsandbox.wikibase.cloud/wiki/Main_Page'
...
import re
q_re = re.compile(r'(<?https?://pbsandbox.wikibase.cloud/(entity|wiki)/)?(Q[0-9]+)>?')
q_re_group_id = 3
p_re = re.compile(r'(<?https?://pbsandbox.wikibase.cloud/(entity/|wiki/Property:))?(P[0-9]+)>?')
p_re_group_id = 3
...
identifier_space = 'https://pbsandbox.wikibase.cloud/entity/'
schema_space = 'https://pbsandbox.wikibase.cloud/prop/direct/'
...
qid_url_pattern = 'https://pbsandbox.wikibase.cloud/wiki/{{id}}'
...
service_name = 'PB sandbox'

# URL (without the trailing slash) where this server runs
this_host = 'https://pbsandbox.wikibase.cloud:8001'
